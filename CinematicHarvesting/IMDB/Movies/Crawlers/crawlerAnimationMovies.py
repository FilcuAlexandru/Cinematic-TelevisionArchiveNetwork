################################################################
#                                                              #
#        '' crawlerAnimationMovies.py Documentation ''         #
# crawlerAnimationMovies.py harvest animation movies from IMDB #
#                                                              #
################################################################

#########################################
#                                       #
# crawlerAnimationMovies.py handy tools #
#                                       #
#########################################
...
#############################################################
#                                                           #
# crawlerAnimationMovies.py ScrapeIMDBAnimationMovies class #
#       Run the scrapping of IMDB animation movies          #
#                                                           # 
#############################################################

class ScrapeIMDBAnimationMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_animation_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'animation_movies.json')
