############################################################
#                                                          #
#       '' crawlerRomanceMovies.py Documentation. ''       #
# crawlerRomanceMovies.py harvest romance movies from IMDB #
#                                                          #
############################################################

#######################################
#                                     #
# crawlerRomanceMovies.py handy tools #
#                                     #
#######################################
...
#      Run the scrapping of IMDB romance movies.        #
#                                                       # 
#########################################################

class ScrapeIMDBRomanceMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_romance_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'romance_movies.json')
