################################################################
#                                                              #
#        '' crawlerAdventureMovies.py Documentation. ''        #
# crawlerAdventureMovies.py harvest adventure movies from IMDB #
#                                                              #
################################################################

#########################################
#                                       #
# crawlerAdventureMovies.py handy tools #
#                                       #
#########################################
...
#############################################################
#                                                           #
# crawlerAdventureMovies.py ScrapeIMDBAdventureMovies class #
#         Run the scrapping of IMDB action movies.          #
#                                                           # 
#############################################################

class ScrapeIMDBAdventureMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_adventure_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'adventure_movies.json')
...
# Usage example:
scraper = ScrapeIMDBAdventureMovies()
url = 'https://www.imdb.com/search/title/?title_type=feature&genres=adventure'
output_folder = 'Database/JSONS'
scraper.scrape_adventure_movies(url, output_folder)
