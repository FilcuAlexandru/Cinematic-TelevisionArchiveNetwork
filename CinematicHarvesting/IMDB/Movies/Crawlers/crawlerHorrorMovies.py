##########################################################
#                                                        #
#      '' crawlerHorrorMovies.py Documentation. ''       #
# crawlerHorrorMovies.py harvest horror movies from IMDB #
#                                                        #
##########################################################

######################################
#                                    #
# crawlerHorrorMovies.py handy tools #
#                                    #
######################################
...
#######################################################
#                                                     #
# crawlerHorrorMovies.py ScrapeIMDBHorrorMovies class #
#      Run the scrapping of IMDB horror movies.       #
#                                                     # 
#######################################################

class ScrapeIMDBHorrorMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_horror_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'horror_movies.json')
