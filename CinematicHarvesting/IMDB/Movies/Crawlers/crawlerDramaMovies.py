########################################################
#                                                      #
#      '' crawlerDramaMovies.py Documentation. ''      #
# crawlerDramaMovies.py harvest drama movies from IMDB #
#                                                      #
########################################################

#####################################
#                                   #
# crawlerDramaMovies.py handy tools #
#                                   #
#####################################
...
#####################################################
#                                                   #
# crawlerDramaMovies.py ScrapeIMDBDramaMovies class #
#      Run the scrapping of IMDB drama movies.      #
#                                                   # 
#####################################################

class ScrapeIMDBDramaMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_drama_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'drama_movies.json')
...
# Usage example:
scraper = ScrapeIMDBDramaMovies()
url = 'https://www.imdb.com/search/title/?title_type=feature&genres=drama'
output_folder = 'Database/JSONS'
scraper.scrape_drama_movies(url, output_folder)
