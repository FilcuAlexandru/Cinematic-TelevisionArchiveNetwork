##########################################################
#                                                        #
#        '' crawlerActionMovies.py Documentation. ''     #
# crawlerActionMovies.py harvest action movies from IMDB #
#                                                        #
##########################################################

######################################
#                                    #
# crawlerActionMovies.py handy tools #
#                                    #
######################################
...
#######################################################
#                                                     #
# crawlerActionMovies.py ScrapeIMDBActionMovies class #
#         Run the scrapping of IMDB action movies.    #
#                                                     # 
#######################################################


class ScrapeIMDBActionMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_action_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'action_movies.json')
