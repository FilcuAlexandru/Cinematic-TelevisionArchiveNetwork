############################################################
#                                                          #
#       '' crawlerWesternMovies.py Documentation ''        #
# crawlerWesternMovies.py harvest western movies from IMDB #
#                                                          #
############################################################

#######################################
#                                     #
# crawlerWesternMovies.py handy tools #
#                                     #
#######################################
...
##########################################################
#                                                        #
# crawlerWesternMovies.py ScrapeIMDBWesternMovies class  #
#        Run the scrapping of IMDB western movies        #
#                                                        # 
##########################################################
...
class ScrapeIMDBWesternMovies:
    ...
    def scrape_western_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'western_movies.json')
...
# Usage example:
scraper = ScrapeIMDBWesternMovies()
url = 'https://www.imdb.com/search/title/?title_type=feature&genres=western'
output_folder = 'Database/JSONS'
scraper.scrape_western_movies(url, output_folder)
