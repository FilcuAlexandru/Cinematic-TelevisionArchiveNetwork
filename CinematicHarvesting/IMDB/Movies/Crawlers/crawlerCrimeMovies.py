########################################################
#                                                      #
#      '' crawlerCrimeMovies.py Documentation. ''      #
# crawlerCrimeMovies.py harvest crime movies from IMDB #
#                                                      #
########################################################

#####################################
#                                   #
# crawlerCrimeMovies.py handy tools #
#                                   #
#####################################
...
#####################################################
#                                                   #
# crawlerCrimeMovies.py ScrapeIMDBCrimeMovies class #
#      Run the scrapping of IMDB crime movies.      #
#                                                   # 
#####################################################
...
class ScrapeIMDBCrimeMovies:
    ...
    def scrape_crime_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'crime_movies.json')
...
# Usage example:
scraper = ScrapeIMDBCrimeMovies()
url = 'https://www.imdb.com/search/title/?title_type=feature&genres=crime'
output_folder = 'Database/JSONS'
scraper.scrape_crime_movies(url, output_folder)
