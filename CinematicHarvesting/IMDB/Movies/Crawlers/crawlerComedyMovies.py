#############################################################
#                                                           #
#       '' crawlerComedyMovies.py Documentation ''          #
# crawlerComedyMovies.py harvest comedy movies from IMDB    #
#                                                           #
#############################################################

######################################
#                                    #
# crawlerComedyMovies.py handy tools #
#                                    #
######################################
...
##########################################################
#                                                        #
# crawlerComedyMovies.py ScrapeIMDBComedyMovies class    #
#        Run the scrapping of IMDB comedy movies.        #
#                                                        # 
##########################################################

class ScrapeIMDBComedyMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_comedy_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'comedy_movies.json')
