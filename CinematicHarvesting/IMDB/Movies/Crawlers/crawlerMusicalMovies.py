############################################################
#                                                          #
#       '' crawlerMusicalMovies.py Documentation ''        #
# crawlerMusicalMovies.py harvest musical movies from IMDB #
#                                                          #
############################################################

#######################################
#                                     #
# crawlerMusicalMovies.py handy tools #
#                                     #
#######################################
...
##########################################################
#                                                        #
# crawlerMusicalMovies.py ScrapeIMDBMusicalMovies class  #
#        Run the scrapping of IMDB musical movies        #
#                                                        # 
##########################################################

class ScrapeIMDBMusicalMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_musical_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'musical_movies.json')
...
# Usage example:
scraper = ScrapeIMDBMusicalMovies()
url = 'https://www.imdb.com/search/title/?title_type=feature&genres=musical'
output_folder = 'Database/JSONS'
scraper.scrape_musical_movies(url, output_folder)
