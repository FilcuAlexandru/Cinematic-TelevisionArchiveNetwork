##########################################################
#                                                        #
#      '' .crawlerSci-FiMovies.py Documentation. ''      #
# crawlerSci-FiMovies.py harvest sci-fi movies from IMDB #
#                                                        #
##########################################################

################################
#                              #
# crawlerSci-FI.py handy tools #
#                              #
################################
...
#################################################
#                                               #
# crawlerSci-FI.py ScrapeIMDBSci-FiMovies class #
#   'Run the scrapping of IMDB sci-fi movies'   #
#                                               # 
#################################################

class ScrapeIMDBSciFIMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_scifi_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'scifi_movies.json')
...
# Usage example:
scraper = ScrapeIMDBSciFIMovies()
url = 'https://www.imdb.com/search/title/?title_type=feature&genres=sci-fi'
output_folder = 'Database/JSONS'
scraper.scrape_scifi_movies(url, output_folder)
