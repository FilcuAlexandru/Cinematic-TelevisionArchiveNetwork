##############################################################
#                                                            #
#       '' crawlerThrillerMovies.py Documentation. ''        #
# crawlerThrillerMovies.py harvest thriller movies from IMDB #
#                                                            #
##############################################################

########################################
#                                      #
# crawlerThrillerMovies.py handy tools #
#                                      #
########################################
...
###########################################################
#                                                         #
# crawlerThrillerMovies.py ScrapeIMDBThrillerMovies class #
#       Run the scrapping of IMDB thriller movies         #
#                                                         # 
###########################################################
...
class ScrapeIMDBThrillerMovies:
    def __init__(self):
        self.headers = {
    ...
    def scrape_thriller_movies(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'thriller_movies.json')
...
# Usage example:
scraper = ScrapeIMDBThrillerMovies()
url = 'https://www.imdb.com/search/title/?title_type=feature&genres=thriller'
output_folder = 'Database/JSONS'
scraper.scrape_thriller_movies(url, output_folder)
