##############################################################
#                                                            #
#        '' .crawlerSciFiTVSeries.py Documentation. ''       #
# crawlerSciFiTVSeries.py harvest sci-fi tv-series from IMDB #
#                                                            #
##############################################################

#######################################
#                                     #
# crawlerSciFiTVSeries.py handy tools #
#                                     #
#######################################
...
#########################################################
#                                                       #
# crawlerSciFiTVSeries.py ScrapeIMDBSciFiTVSeries class #
#      'Run the scrapping of IMDB sci-fi tv-series'     #
#                                                       # 
#########################################################

class ScrapeIMDBSciFiTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_scifi_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'scifi_tvseries.json')
...
# Usage example:
scraper = ScrapeIMDBSciFiTVSeries()
url = 'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=sci-fi'
output_folder = 'Database/JSONS'
scraper.scrape_scifi_tvseries(url, output_folder)