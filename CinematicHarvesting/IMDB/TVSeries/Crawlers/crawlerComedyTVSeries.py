################################################################
#                                                              #
#        '' crawlerComedyTVSeries.py Documentation. ''         #
# crawlerComedyTVSeries.py harvest comedy tv-series from IMDB  #
#                                                              #
################################################################

########################################
#                                      #
# crawlerComedyTVSeries.py handy tools #
#                                      #
########################################
...
###########################################################
#                                                         #
# crawlerComedyTVSeries.py ScrapeIMDBComedyTVSeries class #
#       Run the scrapping of IMDB comedy tv-series.       #
#                                                         #  
###########################################################

class ScrapeIMDBComedyTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_comedy_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'comedy_tvseries.json')
