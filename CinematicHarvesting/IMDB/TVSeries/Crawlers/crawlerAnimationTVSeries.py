#####################################################################
#                                                                   #
#        '' crawlerAnimationTVSeries.py Documentation. ''           #
# crawlerAnimationTVSeries.py harvest animation tv-series from IMDB #
#                                                                   #
#####################################################################

###########################################
#                                         #
# crawlerAnimationTVSeries.py handy tools #
#                                         #
###########################################
...
#################################################################
#                                                               #
# crawlerAnimationTVSeries.py ScrapeIMDBAnimationTVSeries class #
#         Run the scrapping of IMDB animation tv-series         #
#                                                               #  
#################################################################
...
class ScrapeIMDBAnimationTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_animation_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'animation_tvseries.json')
...
# Usage example:
scraper = ScrapeIMDBAnimationTVSeries()
url = 'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=animation'
output_folder = 'Database/JSONS'
scraper.scrape_animation_tvseries(url, output_folder)
