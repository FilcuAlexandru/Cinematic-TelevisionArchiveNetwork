###############################################################
#                                                             #
#        '' crawlerHorrorTVSeries.py Documentation. ''        #
# crawlerHorrorTVSeries.py harvest horror tv-series from IMDB #
#                                                             #
###############################################################

########################################
#                                      #
# crawlerHorrorTVSeries.py handy tools #
#                                      #
########################################
...
###########################################################
#                                                         #
# crawlerHorrorTVSeries.py ScrapeIMDBHorrorTVSeries class #
#      'Run the scrapping of IMDB horror tv-series'       #
#                                                         #  
###########################################################

class ScrapeIMDBHorrorTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_horror_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'horror_tvseries.json')
...
# Usage example:
scraper = ScrapeIMDBHorrorTVSeries()
url = 'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=horror'
output_folder = 'Database/JSONS'
scraper.scrape_horror_tvseries(url, output_folder)
