#################################################################
#                                                               #
#        '' crawlerWesternTVSeries.py Documentation. ''         #
# crawlerWesternTVSeries.py harvest western tv-series from IMDB #
#                                                               #
#################################################################

#########################################
#                                       #
# crawlerWesternTVSeries.py handy tools #
#                                       #
#########################################
...
#############################################################
#                                                           #
# crawlerWesternTVSeries.py ScrapeIMDBWesternTVSeries class #
#       'Run the scrapping of IMDB western tv-series'       #
#                                                           #   
#############################################################

class ScrapeIMDBWesternTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_western_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'western_tvseries.json')
...
# Usage example:
scraper = ScrapeIMDBWesternTVSeries()
url = 'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=western'
output_folder = 'Database/JSONS'
scraper.scrape_western_tvseries(url, output_folder)
