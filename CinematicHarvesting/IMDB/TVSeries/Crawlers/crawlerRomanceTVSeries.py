#################################################################
#                                                               #
#        '' crawlerRomanceTVSeries.py Documentation. ''         #
# crawlerRomanceTVSeries.py harvest romance tv-series from IMDB #
#                                                               #
#################################################################

#########################################
#                                       #
# crawlerRomanceTVSeries.py handy tools #
#                                       #
#########################################
...
#############################################################
#                                                           #
# crawlerRomanceTVSeries.py ScrapeIMDBRomanceTVSeries class #
#      'Run the scrapping of IMDB romance tv-series'        #
#                                                           #  
#############################################################

class ScrapeIMDBRomanceTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_romance_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'romance_tvseries.json')
...
# Usage example:
scraper = ScrapeIMDBRomanceTVSeries()
url = 'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=romance'
output_folder = 'Database/JSONS'
scraper.scrape_romance_tvseries(url, output_folder)
