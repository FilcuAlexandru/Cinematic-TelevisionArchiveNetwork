###############################################################
#                                                             #
#         '' crawlerSportTVSeries.py Documentation. ''        #
# crawlerSportTVSeries.py harvest romance tv-series from IMDB #
#                                                             #
###############################################################

#######################################
#                                     #
# crawlerSportTVSeries.py handy tools #
#                                     #
#######################################
...
#########################################################
#                                                       #
# crawlerSportTVSeries.py ScrapeIMDBSportTVSeries class #
#     'Run the scrapping of IMDB romance tv-series'     #
#                                                       #  
#########################################################

class ScrapeIMDBSportTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_sport_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'sport_tvseries.json')
...
# Usage example:
scraper = ScrapeIMDBSportTVSeries()
url = 'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=sport'
output_folder = 'Database/JSONS'
scraper.scrape_sport_tvseries(url, output_folder)
