###############################################################
#                                                             #
#        '' crawlerActionTVSeries.py Documentation. ''        #
# crawlerActionTVSeries.py harvest action tv-series from IMDB #
#                                                             #
###############################################################

########################################
#                                      #
# crawlerActionTVSeries.py handy tools #
#                                      #
########################################
...
###########################################################
#                                                         #
# crawlerActionTVSeries.py ScrapeIMDBActionTVSeries class #
#       Run the scrapping of IMDB action tv-series.       #
#                                                         # 
###########################################################

class ScrapeIMDBActionTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_action_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'action_tvseries.json')
