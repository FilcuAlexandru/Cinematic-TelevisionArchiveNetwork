#################################################################
#                                                               #
#        '' crawlerMusicalTVSeries.py Documentation. ''         #
# crawlerMusicalTVSeries.py harvest musical tv-series from IMDB #
#                                                               #
#################################################################

#########################################
#                                       #
# crawlerMusicalTVSeries.py handy tools #
#                                       #
#########################################
...
#############################################################
#                                                           #
# crawlerMusicalTVSeries.py ScrapeIMDBMusicalTVSeries class #
#      'Run the scrapping of IMDB musical tv-series'        #
#                                                           #  
#############################################################

class ScrapeIMDBMusicalTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_musical_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'musical_tvseries.json')
...
# Usage example:
scraper = ScrapeIMDBMusicalTVSeries()
url = 'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=musical'
output_folder = 'Database/JSONS'
scraper.scrape_musical_tvseries(url, output_folder)
