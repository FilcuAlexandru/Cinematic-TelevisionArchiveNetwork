##############################################################
#                                                            #
#        '' crawlerDramaTVSeries.py Documentation. ''        #
# crawlerDramaTVSeries.py harvest drama tv-series from IMDB  #
#                                                            #
##############################################################

#######################################
#                                     #
# crawlerDramaTVSeries.py handy tools #
#                                     #
#######################################
...
#########################################################
#                                                       #
# crawlerDramaTVSeries.py ScrapeIMDBDramaTVSeries class #
#      'Run the scrapping of IMDB drama tv-series'      #
#                                                       #  
#########################################################

class ScrapeIMDBDramaTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_drama_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'drama_tvseries.json')
...
# Usage example:
scraper = ScrapeIMDBDramaTVSeries()
url = 'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=drama'
output_folder = 'Database/JSONS'
scraper.scrape_drama_tvseries(url, output_folder)
