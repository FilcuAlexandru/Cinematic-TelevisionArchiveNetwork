##############################################################
#                                                            #
#        '' crawlerCrimeTVSeries.py Documentation. ''        #
# crawlerCrimeTVSeries.py harvest crime tv-series from IMDB  #
#                                                            #
##############################################################

#######################################
#                                     #
# crawlerCrimeTVSeries.py handy tools #
#                                     #
#######################################
...
##########################################################
#                                                        #
# crawlerCrimeTVSeries.py ScrapeIMDBcrimeTVSeries class  #
#       Run the scrapping of IMDB crime tv-series.       #
#                                                        #  
###########################################################

class ScrapeIMDBCrimeTVSeries:
    def __init__(self):
        self.headers = {
    ...
    def scrape_crime_tvseries(self, url, output_folder):
        try:
            ...
            output_file = os.path.join(output_folder, 'crime_tvseries.json')
...
# Usage example:
scraper = ScrapeIMDBCrimeTVSeries()
url = 'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=crime'
output_folder = 'Database/JSONS'
scraper.scrape_crime_tvseries(url, output_folder)
